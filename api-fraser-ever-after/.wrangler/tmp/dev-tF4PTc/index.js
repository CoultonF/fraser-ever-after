...
// .wrangler/tmp/bundle-L8d1Q0/checked-fetch.js
...
// .wrangler/tmp/bundle-L8d1Q0/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();
...
// .wrangler/tmp/bundle-L8d1Q0/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
var RsvpCreate = class extends K {
  async handle(request, env, context, data) {
    ...
    if (remainingInvites >= rsvpToCreate.rsvps.length) {
      return new Response(void 0, { status: 200, headers: { "access-control-allow-origin": "*" } });
    } else {
