...
// .wrangler/tmp/bundle-y5qW35/checked-fetch.js
...
// .wrangler/tmp/bundle-y5qW35/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();
...
// .wrangler/tmp/bundle-y5qW35/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
init_checked_fetch();
init_modules_watch_stub();
var RsvpUpdateSchema = {
  rsvp_id: Number,
  first_name: new j(),
  last_name: new j(),
  dietary_restrictions: new j()
};
var InviteUpdateSchema = {
  invite_id: new j({ required: true }),
  attending: new j({ required: true }),
  rsvps: [RsvpUpdateSchema]
};
var RsvpDeleteSchema = [Number];
var Rsvp = {
  first_name: new j(),
  last_name: new j(),
  dietary_restrictions: new j()
...
// src/endpoints/rsvpCreate.ts
var RsvpCreate = class extends K {
  async handle(request, env, context, data) {
    ...
    if (inviteRsvp.length > 0)
      await env.DB.batch(inviteRsvp);
    ...
    if (remainingInvites >= rsvpToCreate.rsvps.length) {
      ...
      return new Response("Not enough invites", { status: 400, headers: corsHeaders });
    }
  }
};
__publicField(RsvpCreate, "schema", {
  tags: ["RSVP"],
  summary: "Create a new rsvp",
  requestBody: Invite
});

// src/endpoints/rsvpFetch.ts
init_checked_fetch();
init_modules_watch_stub();
var RsvpFetch = class extends K {
  async handle(request, env, context, data) {
    if (request.method === "OPTIONS") {
      return new Response(null, { headers: corsHeaders });
    }
    ...
    return new Response(JSON.stringify(inviteResults), { status: 200, header: corsHeaders });
  }
};
__publicField(RsvpFetch, "schema", {
  tags: ["RSVP"],
  summary: "Fetch rsvps",
  parameters: {
    inviteId: M(String, {
...
// src/endpoints/inviteFetch.ts
init_checked_fetch();
init_modules_watch_stub();
var InviteFetch = class extends K {
  async handle(request, env, context, data) {
    if (request.method === "OPTIONS") {
      return new Response(null, { headers: corsHeaders });
    }
    ...
    return new Response(JSON.stringify(inviteResults), { headers: corsHeaders });
  }
};
__publicField(InviteFetch, "schema", {
  tags: ["RSVP"],
...
// src/endpoints/inviteUpdate.ts
init_checked_fetch();
init_modules_watch_stub();
var InviteUpdate = class extends K {
  async handle(request, env, context, data) {
    if (request.method === "OPTIONS") {
      return new Response(null, { headers: corsHeaders });
    }
    ...
    if (inviteResults.length !== 1) {
      return new Response("Invite not found", { headers: corsHeaders });
    }
    const rsvpBatches = [];
    ...
    if (rsvpBatches.length > 0)
      await env.DB.batch(rsvpBatches);
    return new Response(null, { status: 200, headers: corsHeaders });
  }
};
__publicField(InviteUpdate, "schema", {
  tags: ["Invite"],
  summary: "Update an existing invite",
  requestBody: InviteUpdateSchema
});

// src/endpoints/inviteDelete.ts
init_checked_fetch();
init_modules_watch_stub();
var RsvpDelete = class extends K {
  async handle(request, env, context, data) {
    if (request.method === "OPTIONS") {
      return new Response(null, { headers: corsHeaders });
    }
...
__publicField(RsvpDelete, "schema", {
  tags: ["RSVP"],
