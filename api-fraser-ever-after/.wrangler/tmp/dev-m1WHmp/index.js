...
// .wrangler/tmp/bundle-zQ3odt/checked-fetch.js
...
// .wrangler/tmp/bundle-zQ3odt/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();
...
// .wrangler/tmp/bundle-zQ3odt/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
var RsvpCreate = class extends K {
  async handle(request, env, context, data) {
    ...
    if (remainingInvites >= rsvpToCreate.rsvps.length) {
      ...
      return new Response("Not enough invites", { status: 400 });
    }
  }
};
