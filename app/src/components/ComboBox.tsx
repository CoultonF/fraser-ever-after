  ...
  return (
    <Listbox multiple as="div" value={selectedPerson} onChange={setSelectedPerson}>
      <div className="relative">
        ...
        {allOptions.length > 0 && (
          <Listbox.Options className="absolute flex flex-col z-10 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
